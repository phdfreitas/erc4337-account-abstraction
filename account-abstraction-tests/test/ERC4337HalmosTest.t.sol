...
contract ERC4337Test is Test {
    ...
    function check_testDepositTo() public {
    ...
    function check_testDepositZeroEther_ShouldNotChangeBalance() public {
    ...
    function check_testDepositMaxEther() public {
    ...
    function check_testDeposit_Overflow() public {
    ...
    function check_testWithdrawTo_ValidAmount() public {
        uint256 depositAmount = 1 ether;
        entryPoint.depositTo{value: depositAmount}(mockedUser);
        uint256 initialBalance = entryPoint.balanceOf(mockedUser);
    ...
    function check_testWithdraw_MoreThanBalance_ShouldFail() public {
    ...
    function check_testWithdraw_ZeroEther() public {
    ...
    function check_testWithdraw_ExactBalance() public {
    ...
    function check_testWithdrawMaxEther_ShouldFail() public {
        uint256 depositAmount = 1 ether;
    ...
    function check_testHandleOps_Invalid() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    function check_testHandleOps_ValidationFailsDueToInsufficientBalance() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    // AA23 reverted
    function check_testHandleOps_AccountValidationFails() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    function check_testHandleOps_GasValuesOverflow() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    function check_testHandleOps_InsufficientPrefund() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    function check_testHandleOps_InvalidNonce() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    function check_testHandleOps_OverVerificationGasLimit() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    function check_testHandleOps_InsufficientGas() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    function check_testHandleOps_InvalidSignature() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    function check_testHandleOps_InvalidCallData() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    function check_testCreateSenderIfNeeded_FailedInitCode() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    function check_testCreateSenderIfNeeded_AlreadyConstructed() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
        ops[0] = op;
    ...
    function check_testHandleOps_AA24_SignatureError() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    function check_testHandleOps_CopyUserOpToMemory_ValidData() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
    ...
    // 
    function check_testHandleOps_CopyUserOpToMemory_InvalidPaymasterData() public {
        PackedUserOperation[] memory ops = new PackedUserOperation[](1);
        PackedUserOperation memory op = createmockedUserOp();
